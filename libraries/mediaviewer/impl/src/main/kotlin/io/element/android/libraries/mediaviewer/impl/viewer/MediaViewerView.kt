        ...
        HorizontalPager(
            ...
            when (val dataForPage = state.listData[page]) {
                ...
                is MediaViewerPageData.MediaViewerData -> {
                    ...
                    val isMediaValid = dataForPage.validationState.value.dataOrNull()
...
private fun MediaViewerPage(
    ...
    MediaViewerFlickToDismiss(
        ...
        Box(
            ...
            AnimatedVisibility(
                visible = data.validationState.value.isLoading(),
            ...
            Box(contentAlignment = Alignment.Center) {
                ...
                val isMediaValid = data.validationState.value.dataOrNull()
