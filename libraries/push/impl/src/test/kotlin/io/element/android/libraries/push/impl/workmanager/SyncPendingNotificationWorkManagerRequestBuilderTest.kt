...
class SyncPendingNotificationWorkManagerRequestBuilderTest {
    @Test
    fun `build - success API 33`() = runTest {
        val request = createSyncPendingNotificationWorkManagerRequestBuilder(
        ...
        result.getOrNull()!!.run {
            ...
            requests.first().run {
                ...
                assertThat(workSpec.input.hasKeyWithValueOfType<String>("session_id")).isTrue()
                // True in API 33+
...
private fun createSyncPendingNotificationWorkManagerRequestBuilder(
    sessionId: SessionId,
    sdkVersion: Int = 33,
