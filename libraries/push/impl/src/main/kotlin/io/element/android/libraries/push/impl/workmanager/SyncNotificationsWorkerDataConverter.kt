...
class SyncNotificationsWorkerDataConverter(
    ...
    fun deserialize(data: Data): List<NotificationEventRequest>? {
        ...
        return runCatchingExceptions {
            json().decodeFromString<List<DefaultSyncNotificationWorkManagerRequestBuilder.Data>>(rawRequestsJson).map { it.toRequest() }
        }.fold(
            onSuccess = {
...
private fun NotificationEventRequest.toData(): DefaultSyncNotificationWorkManagerRequestBuilder.Data {
    return DefaultSyncNotificationWorkManagerRequestBuilder.Data(
...
private fun DefaultSyncNotificationWorkManagerRequestBuilder.Data.toRequest(): NotificationEventRequest {
