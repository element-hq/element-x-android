...
class DefaultWellknownRetriever(
    ...
    private fun url(host: String, source: ElementWellKnownSource): String {
        val elementWellKnownUrl = "https://$host/.well-known/element/element.json"
        return when (source) {
            ElementWellKnownSource.ESS_CONFIG -> enterpriseService.essConfigEndpointUrl(host) ?: elementWellKnownUrl
