...
class DefaultWorkManagerScheduler(
    ...
    override fun submit(workManagerRequestFactory: WorkManagerRequestFactory) {
        workManagerRequestFactory.create().fold(
            onSuccess = { workRequests ->
                workManager.enqueue(workRequests)
            },
            onFailure = {
                Timber.e(it, "Failed to build WorkManager request $workManagerRequestFactory")
            }
        )
    }
