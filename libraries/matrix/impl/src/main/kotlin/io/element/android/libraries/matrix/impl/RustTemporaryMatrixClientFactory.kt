...
class RustTemporaryMatrixClientFactory(
    ...
    override suspend fun createTemporaryMatrixClient(homeServerUrl: String): Result<UnauthenticatedMatrixClient> {
        return runCatchingExceptions {
            ...
            val client = rustMatrixClientFactory.getBaseClientBuilder(
                ...
                .build()
            RustUnauthenticatedMatrixClient(client, sessionPaths)
        }
    }
}
