...
class RustKnockRequest(
    ...
    override suspend fun accept(): Result<Unit> = catchingExceptions {
        inner.actions.accept()
    }

    override suspend fun decline(reason: String?): Result<Unit> = catchingExceptions {
        inner.actions.decline(reason)
    }

    override suspend fun declineAndBan(reason: String?): Result<Unit> = catchingExceptions {
        inner.actions.declineAndBan(reason)
    }

    override suspend fun markAsSeen(): Result<Unit> = catchingExceptions {
