        ...
        projects {
            excludes.addAll(
                listOf(
                    ":anvilannotations",
                    ":anvilcodegen",
                    ":features:createroom:test",
                    ":features:invitelist:test",
                    ":features:leaveroom:test",
                    ":features:lockscreen:test",
                    ":features:messages:test",
                    ":features:networkmonitor:test",
                    ":features:rageshake:test",
                    ":libraries:cryptography:test",
                    ":libraries:dateformatter:test",
                    ":libraries:eventformatter:test",
                    ":libraries:featureflag:test",
                    ":libraries:matrix:test",
                    ":libraries:mediapickers:test",
                    ":libraries:mediaplayer:test",
                    ":libraries:mediaupload:test",
                    ":libraries:mediaviewer:test",
                    ":libraries:permissions:test",
                    ":libraries:preferences:test",
                    ":libraries:push:test",
                    ":libraries:pushstore:test",
                    ":libraries:session-storage:test",
                    ":libraries:textcomposer:test",
                    ":libraries:usersearch:test",
                    ":libraries:voicerecorder:test",
                    ":samples:minimal",
                    ":services:analytics:test",
                    ":services:appnavstate:test",
                    ":services:toolbox:test",
                    ":tests:testutils",
                )
            )
        }
