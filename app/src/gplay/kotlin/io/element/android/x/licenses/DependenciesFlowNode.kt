...
class DependenciesFlowNode @AssistedInject constructor(
    ...
    backstack = BackStack(initialElement = NavTarget.LicensesList, savedStateMap = buildContext.savedStateMap),
        ...
        return when (navTarget) {
            is NavTarget.LicensesList -> {
                val callback = object : DependencyLicensesListNode.Callback {
                    override fun onLicenseSelected(license: DependencyLicenseItem) {
