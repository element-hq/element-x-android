...
class SetupBiometricPresenter @Inject constructor() : Presenter<SetupBiometricState> {
    ...
    override fun present(): SetupBiometricState {
        ...
        fun handleEvents(event: SetupBiometricEvents) {
            when (event) {
                SetupBiometricEvents.Allow -> isBiometricSetupDone = true
                SetupBiometricEvents.Skip -> isBiometricSetupDone = true
            }
        }
