...
fun SendLocationView(
    ...
    when (state.permissionDialog) {
        ...
        SendLocationState.Dialog.PermissionDenied -> PermissionDeniedDialog(
            onContinue = {
                // TODO // state.eventSink(SendLocationEvents.OpenAppSettings)
                openAppSettingsPage(context as Activity)
            },
...
private fun PermissionRationaleDialog(
    ...
    ConfirmationDialog(
        content = "To send a location, allow Element to access your location.",
...
private fun PermissionDeniedDialog(
    ...
    ConfirmationDialog(
        content = "Location permission missing, to enable it click continue to go to settings.",
        onSubmitClicked = { onContinue() },
        onDismiss = { onDismiss() },
        submitText = stringResource(CommonStrings.action_continue),
        cancelText = stringResource(CommonStrings.action_cancel),
