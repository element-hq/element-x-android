...
import io.element.android.features.mediapreview.impl.imageeditor.NormalizedCropRect
...
sealed interface MediaPreviewEvents {
    ...
    data object OpenImageEditor : MediaPreviewEvents
    data object CloseImageEditor : MediaPreviewEvents
    data object RotateImageToTheLeft : MediaPreviewEvents
    data object ApplyImageEdits : MediaPreviewEvents
    data object ResetImageEdits : MediaPreviewEvents
    data class UpdateImageCropRect(val cropRect: NormalizedCropRect) : MediaPreviewEvents
    data object ClearImageEditError : MediaPreviewEvents
}
