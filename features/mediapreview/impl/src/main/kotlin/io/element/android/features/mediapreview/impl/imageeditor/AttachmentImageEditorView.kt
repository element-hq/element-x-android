...
package io.element.android.features.mediapreview.impl.imageeditor
...
fun AttachmentImageEditorView(
    ...
    val rotateContentDescription = stringResource(MediaPreviewR.string.screen_image_edition_a11y_rotate_to_the_left)
    val rotationStateDescription = pluralStringResource(
        MediaPreviewR.plurals.screen_image_edition_a11y_rotation_state,
            ...
            TopAppBar(
                ...
                title = {
                    Text(
                        ...
                        text = stringResource(MediaPreviewR.string.screen_image_edition_title),
                    )
                },
            )
        }
