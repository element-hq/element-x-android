...
enum class PredefinedUserStatus(val emoji: String, @StringRes val labelRes: Int) {
    IN_A_MEETING("💬", CommonStrings.common_user_status_in_a_meeting),
    FOCUS_TIME("💡", CommonStrings.common_user_status_focus_time),
    ON_THE_ROAD("🚙", CommonStrings.common_user_status_on_the_road),
    BE_RIGHT_BACK("☕", CommonStrings.common_user_status_be_right_back),
    AWAY("🌴", CommonStrings.common_user_status_away),
}
