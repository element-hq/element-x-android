...
sealed interface AdvancedSettingsEvents {
    ...
    data class SetDynamicColorEnabled(val enabled: Boolean) : AdvancedSettingsEvents
    data class SetHighContrastEnabled(val enabled: Boolean) : AdvancedSettingsEvents
