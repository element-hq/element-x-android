...
class ResetIdentityConfirmationNode @AssistedInject constructor(
    ...
    private val host = inputs<Inputs>().host

    @Composable
    override fun View(modifier: Modifier) {
        ResetIdentityConfirmationView(
            state = ResetIdentityConfirmationState(host),
            onContinue = { callback.onContinue() },
            onBack = { callback.onCancel() }
        )
    }
}
